...
export { buildDiffDecos, computeSpacers, trimChunkEdges, drawFlowConnections, createResizingWidget, RevertGutterMarker, SpacerWidget, DiffGutterMarker, updateScrollbarMarkers } from './components/CodeEditor/diffUtils';
