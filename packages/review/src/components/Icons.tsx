export function IconFiles({ size = 22 }: { size?: number }) {
  return (
...
export function IconComment({ size = 22 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
...
export function IconPalette({ size = 22 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
...
export function IconSend({ size = 12 }: { size?: number }) {
  return (
...
export function IconFileDoc({ size = 14 }: { size?: number }) {
  return (
...
export function SwatchPair({ bg, accent, size = 12 }: { bg: string; accent: string; size?: number }) {
  return (
    <span
