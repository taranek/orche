...
export function SubmitReviewButton({ onClick }: SubmitReviewButtonProps) {
  return (
    <button
      onClick={onClick}
      className="inline-flex items-center gap-2.5 h-[34px] px-3.5 rounded-2xl border border-edge-active bg-elevated overflow-hidden shadow-[0_1px_3px_rgba(0,0,0,0.2),0_0_0_1px_rgba(255,255,255,0.03)_inset] hover:shadow-[0_2px_6px_rgba(0,0,0,0.25),0_0_0_1px_rgba(255,255,255,0.06)_inset] hover:bg-hover/50 active:scale-[0.96] transition-[transform,box-shadow] cursor-pointer"
    >
